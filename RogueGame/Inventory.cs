    ...
    internal class Inventory
    {
        ...
        private void LoadInventory()
        {
            this.invItems = new List<Inventory>()
            {
                ...
                new Inventory(InvCategory.Potion, InvTemplateID.PotionOfRestoreStrength, "", "Restore Strength", "Restore Strength", false, true, false, false, false, false, 0, 0, 0, 0, 0, 0, 0, 1000, 0, new MapGlyph('¡', Color.HotPink, Color.Black)),
