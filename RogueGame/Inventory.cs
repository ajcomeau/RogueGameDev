    ...
    internal class Inventory
    {
        ...
        private void LoadInventory()
        {
            this.invItems = new List<Inventory>()
            {
                ...
                new Inventory(InvCategory.Scroll, InvTemplateID.ScrollOfCreateMonster, "", "Create Monster", "Create Monster", false, true, false, true, false, false,0, 0, 0, 0, 0, 0, 0, 2000, 0, new MapGlyph('♪', Color.HotPink, Color.Black), "", ""),
