    ...
    internal class Inventory
    {
        ...
        private void LoadInventory()
        {
            ...
            { 
                ...
                new Inventory(InvCategory.Armor, 8, "studded leather armor", "studded leather armor", "studded leather armor", false, false, true, false, false, 3, 1, 0, 0, 0, 0, 0, 15, new MapGlyph('◘', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Armor, 9, "leather armor", "leather armor", "leather armor", false, false, false, false, false, 2, 1, 0, 0, 0, 0, 0, 20, new MapGlyph('◘', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Armor, 10, "ring mail", "ring mail", "ring mail", false, false, false, false, false, 3, 0, 0, 0, 0, 0, 0, 15, new MapGlyph('◘', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Armor, 11, "scale mail", "scale mail", "scale mail", false, false, false, false, false, 4, 0, 0, 0, 0, 0, 0, 13, new MapGlyph('◘', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Armor, 12, "chain mail", "chain mail", "chain mail", false, false, false, false, false, 5, 0, 0, 0, 0, 0, 0, 12, new MapGlyph('◘', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Armor, 13, "splint mail", "splint mail", "splint mail", false, false, false, false, false, 6, 0, 0, 0, 0, 0, 0, 10, new MapGlyph('◘', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Armor, 14, "banded mail", "banded mail", "banded mail", false, false, false, false, false, 6, 0, 0, 0, 0, 0, 0, 10, new MapGlyph('◘', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Armor, 15, "plate mail", "plate mail", "plate mail", false, false, false, false, false, 7, 0, 0, 0, 0, 0, 0, 5, new MapGlyph('◘', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Weapon, 16, "mace", "mace", "mace", false, false, true, true, false, 0, 0, 1, 1, 2, 8, -3, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Weapon, 17, "short bow", "short bow", "short bow", false, false, true, true, false, 0, 0, 0, 1, 1, 1, 0, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Weapon, 18, "crossbow", "crossbow", "crossbow", false, false, false, true, false, 0, 0, 0, 1, 1, 1, 0, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Weapon, 19, "dagger", "dagger", "dagger", false, false, false, true, false, 0, 0, 0, 1, 1, 4, 2, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Weapon, 20, "long sword", "long sword", "long sword", false, false, false, true, false, 0, 0, 0, 1, 3, 12, -10, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Weapon, 21, "spear", "spear", "spear", false, false, false, true, false, 0, 0, 0, 1, 1, 8, -2, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Weapon, 22, "two-handed sword", "two-handed sword", "two-handed sword", false, false, false, true, false, 0, 0, 0, 1, 4, 16, -14, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Ammunition, 23, "arrow", "arrow", "arrows", false, true, true, true, false, 0, 0, 0, 0, 1, 1, 4, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Ammunition, 24, "crossbow bolt", "crossbow bolt", "crossbow bolts", false, true, false, true, false, 0, 0, 0, 0, 1,2, 8, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Ammunition, 25, "dart", "dart", "darts", false, true, false, true, false, 0, 0, 0, 0, 1, 1, 2, 10, new MapGlyph('↑', Color.Blue, Color.Black), null),
                new Inventory(InvCategory.Amulet, 26, "The Amulet", "The Amulet", "The Amulet", true, false, false, false, false, 0, 0, 0, 0, 0, 0, 0, 0, new MapGlyph(MapLevel.AMULET.DisplayChar, Color.Yellow, Color.Black), null),
                new Inventory(InvCategory.Gold, 27, "gold", "gold", "gold", true, true, false, false, false, 0, 0, 0, 0, 0, 0, 0, 25, new MapGlyph('*', Color.Gold, Color.Black), null)
            };
        }
