    ...
    internal class Inventory
    {
        ...
        private void LoadInventory()
        {
            ...
            this.invItems = new List<Inventory>()
            {
                ...
                new Inventory(InvCategory.Scroll, InvTemplateID.ScrollOfEnchantArmor, "", "Enchant Armor", "Enchant Armor", false, true, false, true, false, false, 0, 0, 0, 0, 0, 0, 0, 1000, 0, new MapGlyph('♪', Color.HotPink, Color.Black), "", ""),
