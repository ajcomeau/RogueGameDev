    ...
    internal class Inventory
    {
        ...
        private void LoadInventory()
        {
            this.invItems = new List<Inventory>()
            {
                ...
                new Inventory(InvCategory.Potion, InvTemplateID.PotionOfRaiseLevel, "", "Raise Level", "Raise Level", false, true, false, false, false, false, 0, 0, 0, 0, 0, 0, 0, 1000, 0, new MapGlyph('¡', Color.HotPink, Color.Black)),
