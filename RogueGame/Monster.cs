...
namespace RogueGame
{
    internal class Monster : Character
    {
        ...
        private static List<Monster> monsterInc = new List<Monster>()
        {
            ...
            new Monster("Leprechaun"    , 3, 24, 5, 10, 7, 16, 50, 1, 1, new MapGlyph('L', Color.LightGray, Color.Black), 75, Leprechaun, false, 95, false),
            ...
            new Monster("Rattlesnake"   , 2, 16, 5, 20, 9, 18, 50, 1, 6, new MapGlyph('R', Color.LightGray, Color.Black), 85, Rattlesnake, true, 35, false),
        ...
        {
            bool strike = rand.Next(1, 101) <= 85;
            string returnMsg = "";
            int tax = 0;
            Player player;
